...
--   1. Drop table admin_credentials
--   2. CREATE TABLE `admin_credentials` (
--   `USERNAME` varchar(50) COLLATE utf16_bin NOT NULL,
--   `PASSWORD` varchar(50) COLLATE utf16_bin NOT NULL,
--   `IS_LOGGED_IN` TINYINT(1) NOT NULL DEFAULT 0
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf16 COLLATE=utf16_bin;
-- 3. INSERT INTO admin_credentials (USERNAME, PASSWORD, IS_LOGGED_IN) VALUES
-- ('admin', 'admin123', 0);
...
-- ADD `IS_LOGGED_IN` TINYINT(1) NOT NULL DEFAULT 0;
